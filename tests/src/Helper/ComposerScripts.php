...
namespace Drupal\Tests\marvin_behat_product\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-behat-product-tests-project_01',
      'description' => 'drupal/marvin-behat-product-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_behat_product']['fixtures']['filesToSymlink'] ?? [];
